...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d3 = new Department(3, "LIFEPO4");
            Department d4 = new Department(4, "LIPO 50C");
            Department d5 = new Department(5, "Corrupto");


            Seller s1 = new Seller(1, "Big smoke", "FatFakeGrove@rockstar.com", new DateTime(1971, 5, 21), 1500.0, d1);
            Seller s2 = new Seller(2, "Ryder", "KeepUpMotherfucker@rockstar.com", new DateTime(1973, 8, 25), 1300.0, d2);
            Seller s3 = new Seller(3, "Sweet", "GroveForever@rockstar.com", new DateTime(1975, 9, 16), 900.0, d4);
            Seller s4 = new Seller(4, "Carl Jonshon", "HESOYAM@rockstar.com", new DateTime(1973, 11, 22), 2500.0, d3);
            Seller s5 = new Seller(5, "Frank Tempenny", "IamTheGreatest", new DateTime(1965, 1, 9), 12500.0, d5);
            Seller s6 = new Seller(6, "Eddie Pulaski", "IamNotThePuppet", new DateTime(1969, 3, 15), 1700.0, d5);
